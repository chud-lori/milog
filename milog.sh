#!/usr/bin/env bash
# MILOG_VERSION=57007ce-dirty
# MILOG_BUILT=2026-05-01T12:27:54Z
# ==============================================================================
...
mode_daemon() {
    ...
    while :; do
        ...
        # File integrity monitor. Self-throttled by AUDIT_FIM_INTERVAL —
        # cheap to call every tick (returns immediately when not due).
        _audit_fim_tick
